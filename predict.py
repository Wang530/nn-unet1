...
def main(path_input,path_output):
    ...
    input_folder = path_input #输入文件的路径
    output_folder = path_output #输出文件的路径
    #以下属性以默认值的方式呈现
    task_name = "Task076"
    ...
    #                          plans_identifier)
    model_folder_name = '/home/m904/nnUNetFrame/DATASET/nnUNet_trained_models/nnUNet/3d_fullres/Task076_liver1/nnUNetTrainerV2__nnUNetPlansv2.1' #模型所在路径
